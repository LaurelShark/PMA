...
CREATE TABLE `availability` (
  ...
  PRIMARY KEY (`id`),
  KEY `good_id` (`good_id`),
  CONSTRAINT `availability_ibfk_1` FOREIGN KEY (`good_id`) REFERENCES `goods` (`id`)
...
INSERT INTO `availability` VALUES (1,10,15.5,1,2),(2,1,200000,3,1),(3,2,100000,2,2);
...
INSERT INTO `categories` VALUES (1,'grocery'),(2,'sedan'),(3,'SUV'),(4,'Jomn');
...
INSERT INTO `departments` VALUES (1,1,'food'),(2,2,'cars');
...
INSERT INTO `goods` VALUES (1,'stew',1,1,0,0,0,NULL),(2,'Mercedes Benz',2,2,0,0,0,NULL),(3,'Mercedes Gelandewagen',3,2,0,0,0,NULL);
...
-- Dump completed on 2019-03-17 16:10:27
